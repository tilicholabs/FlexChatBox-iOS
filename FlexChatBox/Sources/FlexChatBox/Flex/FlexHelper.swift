...
public enum FlexHelper {
    ...
    static let textFieldPlaceholder = "Type your text here"
    
    static let cameraPermissionAlert = "Please click on the Settings to enable the camera permission"
    ...
    static let micButtonImageName = "mic"
